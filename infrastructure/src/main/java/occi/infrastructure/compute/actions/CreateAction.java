...
/**
 * Implementation of the Action Interface. In this case the CreateAction creates
 * a new definition for a compute resource.
 * 
 * @see Action
...
public class CreateAction extends Action {
	...
	public void execute(URI uri, Method method) {
		...
		computeInterface.createCompute(compute);
	}
}